...
import com.example.e_commericemvp.ui.Activities.cart_activity.adapters.CartItems_Adapter;
...
public class CartActivity extends AppCompatActivity  implements CartContract.CartView{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cartPresenter = new CartPresenter(this , AppRepository.getInstance(this) );
